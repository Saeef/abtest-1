	  ...
	  public static final int NUMBERS_PER_PAGE = 10;
	   ...
	   //当前页码
	    ...
	    public Pagination(String sql){
	      ...
	      new Pagination<E>(sql,currentPage,NUMBERS_PER_PAGE,jTemplate);
	    }
	    ...
	    public Pagination(String sql,int currentPage,int numPerPage,JdbcTemplate jTemplate){
	     ...
	     /** StringBuffer paginationSQL = new StringBuffer(" SELECT * FROM ( ");
	      ...
	      //装入结果集
	      //setData((List<E>)jTemplate.queryForList(getMySQLPageSQL(sql,startIndex,numPerPage) ));
	    }
	    ...
	    public String getMySQLPageSQL(String queryString, Integer startIndex, Integer pageSize)
	    {
	      ...
	      System.out.println("PageSQL:"+result);
	      return result;
	    }
	   ...
	   //计算结束时候的索引
	    ...
	    public String toString() {
	    	// Showing ${pagination.startIndex} to ${pagination.lastIndex} of ${pagination.totalRows} entries
	    	return "\"currentPage\":"+this.getCurrentPage()+",\"totalPages\":"+this.getTotalPages()+",\"numPerPage\":"+this.getNumPerPage() +",\"startIndex\":"+this.startIndex +",\"lastIndex\":"+this.lastIndex +",\"totalRows\":"+this.totalRows;
	    }
}
